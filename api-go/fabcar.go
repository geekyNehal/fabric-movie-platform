...
func main() {
	...
	ccpPath := filepath.Join(
		...
		"vars",
		"profiles",
		"mychannel_connection_for_gosdk.yaml",
	)
	...
	fmt.Println("After connecting gateway")
...
func populateWallet(wallet *gateway.Wallet) error {
	credPath := filepath.Join(
		...
		"cbfc.movie.com",
		"users",
		"Admin@cbfc.movie.com",
		"msp",
	)

	certPath := filepath.Join(credPath, "signcerts", "Admin@cbfc.movie.com-cert.pem")
