...
jq '.channel_group.groups.Application.groups."tokenplatform-movie-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.1.5","port": 7005}]},"version": "0"}}' mychannel_current_config.json > mychannel_modified_anchor_config.json
