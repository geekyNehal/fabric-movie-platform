...
let oked=0
let total=0
declare -a allpeernodes=(peer0.cbfc.movie.com peer0.tokenplatform.movie.com peer0.inox.movie.com peer0.pvr.movie.com)
...
declare -a allorderernodes=(orderer1.orderer)
